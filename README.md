...
MASSIVE inspiration (theft) taken from @Alfarizi's config (bc i didnt know how to make typescript and other vscode-like features work)
    P.S. I despise that i used so many vscode-like features (*cough* avante) but i will likely remove them with time. i'm just cant afford the massive development slowdown ive experienced so far in my switch.
